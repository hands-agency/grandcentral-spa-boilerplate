...
-- Généré le :  Lun 24 Juillet 2017 à 16:34
...
(5, 'logout', '{"fr":"Log out","en":"Log out"}', '{"fr":"","en":""}', '{"fr":"","en":""}', '{"fr":"\\/logout","en":"\\/logout"}', '{"key":"content","http_status":"200 OK","content_type":"routine","url":"","master":{"app":"form","template":"\\/logout"}}', 1, '2014-11-13 13:09:26', '2017-07-22 15:45:47', 'human_2', 'live', 0);
...
--
ALTER TABLE `form`
  MODIFY `id` mediumint(3) unsigned NOT NULL AUTO_INCREMENT COMMENT 'The unique identifier',AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `page`
  MODIFY `id` mediumint(3) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
